...
const TABS: { id: ReportQueue; label: string }[] = [
...
type Props = {
  ...
  queue: ReportQueue;
  onQueue: (queue: ReportQueue) => void;
  counts: Record<ReportQueue, number>;
};

export function ReportsToolbar({ query, onQuery, queue, onQueue, counts }: Props) {
  return (
    <H className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
      ...
      >
        ...
        <H
          ...
          placeholder="Search reporter, listing, or poster"

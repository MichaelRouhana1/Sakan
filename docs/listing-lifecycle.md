...
4. To enable email, set `RESEND_API_KEY` and a verified `EMAIL_FROM` sender. Add comma-separated `ADMIN_NOTIFICATION_EMAILS` for staff follow-up. Local/dev send checks: [resend.md](resend.md).
